...
LOGO_NAMEN: dict[str, str] = {
    "SV Burgweinting": "burgweinting.pdf",
    "SV Harting": "harting.pdf",
    "Donaustauf": "donaustauf.pdf",
    "SG Walhalla": "walhalla.pdf",
    "SV Obertraubling": "obertraubling.pdf",
    "FC Mintraching": "mintraching.pdf",
    "Freier TuS": "tus_regensburg.pdf",
    "Kareth-Lapp.": "kareth2.pdf",
    "FC Oberhinkofen": "oberhinkofen.pdf",
    "Wörth/Donau": "woerth.pdf",
    "FC Laub": "laub.pdf",
    "SC Regensb.": "sc_regensburg.pdf",
    "Pirkensee-P": "pirkensee.pdf",
    "Ziegetsdorf": "ziegetsdorf.png",
}
